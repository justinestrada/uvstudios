...
<div id="toast-cookie-policy" class="toast position-fixed mx-auto" style="display: none;" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" >
  <div class="toast-body bg-white p-3" style="border: 1px solid #ddd;">
    ...
    <small class="d-block text-black m-0">We use cookies to improve your online experience. For more information, visit our <a href="{{ get_site_url() }}/privacy-policy" title="Privacy Policy" class="text-black text-underline" >privacy policy</a>.</small>
  </div>
</div>
