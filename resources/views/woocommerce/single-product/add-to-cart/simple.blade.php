      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col p-md-0">
            <button type="submit" name="add-to-cart" value="{{ esc_attr( $product->get_id() ) }}" class="single_add_to_cart_button button alt w-100">{{ esc_html( $product->single_add_to_cart_text() ) }}</button>
          </div>
        </div>
      </div>
    </div>
